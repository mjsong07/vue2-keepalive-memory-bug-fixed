...
(function (global, factory) {
  ...
  function pruneCache (keepAliveInstance, filter) {
    ...
    var _vnode = keepAliveInstance._vnode; //keepAliveInstance 是当前this keepalive 整个对象
  ...
  var KeepAlive = {
    ...
    render: function render () {
      ...
      if (componentOptions) {
        ...
        var keys = ref$1.keys;
        var key$1 = vnode.key == null
          // same constructor may get registered as different local components
          // so cid alone is not enough (#3269)
          ? componentOptions.Ctor.cid + (componentOptions.tag ? ("::" + (componentOptions.tag)) : '')
          : vnode.key;
        if (cache[key$1]) { //如果缓存map 里已经包含 直接取出
          // console.log("有缓存-直接取",key)
          vnode.componentInstance = cache[key$1].componentInstance;
